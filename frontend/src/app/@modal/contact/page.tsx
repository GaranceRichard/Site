  ...
  return (
    ...
    >
      ...
      <div className="absolute left-1/2 top-1/2 w-[min(760px,92vw)] -translate-x-1/2 -translate-y-1/2">
        <div
          className={[
            "panel-elevated text-[color:var(--text-primary)]",
        ...
        >
          <div className="flex items-start justify-between gap-4 border-b subtle-divider p-6">
            <div>
            ...
            <button type="button" onClick={close} className="secondary-button px-3 py-2 text-sm font-semibold">
              Fermer
            </button>
          </div>
          ...
          <div
            className={[
              ...
              ease,
              dur,
              open ? "opacity-100 translate-y-0 delay-[90ms]" : "opacity-0 translate-y-2 delay-0",
            ].join(" ")}
          >
