...
function SectionTitle({
  ...
  return (
    <div className="max-w-3xl">
      <p className="text-sm font-medium tracking-wide text-neutral-500">{eyebrow}</p>
...
function DetailsAccordion({ title, points }: { title: string; points: string[] }) {
  return (
    <details className="group rounded-2xl border border-neutral-200 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
      <summary className="flex cursor-pointer list-none items-center justify-between gap-4">
        <span className="text-sm font-semibold">{title}</span>
        <span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-neutral-200 bg-white text-sm text-neutral-700">
      ...
      <div className="mt-4 space-y-2">
        <ul className="list-disc space-y-2 pl-5 text-sm leading-relaxed text-neutral-600">
          {points.map((p) => (
            <li key={p}>{p}</li>
          ))}
        </ul>
    ...
    <main className="min-h-screen bg-neutral-50 text-neutral-900">
        ...
        <Container>
          <div className="flex h-[72px] items-center justify-between gap-6">
            <a href="#home" className="flex items-center gap-3">
              <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-neutral-200 bg-white text-sm font-semibold shadow-[0_1px_0_rgba(0,0,0,0.04)]">
                G
              </span>
              <div className="leading-tight">
                <p className="text-sm font-semibold">Garance</p>
                <p className="text-xs text-neutral-500">Coach Lean-Agile</p>
              </div>
            </a>
            ...
            <nav className="hidden items-center gap-5 md:flex">
              ...
              <a
                href="#contact"
                className="rounded-xl border border-neutral-200 bg-neutral-900 px-4 py-2 text-sm font-semibold text-white shadow-[0_1px_0_rgba(0,0,0,0.04)] hover:bg-neutral-800"
              >
                Prendre contact
              </a>
            </nav>
            ...
            <a
              href="#contact"
              className="md:hidden rounded-xl border border-neutral-200 bg-neutral-900 px-4 py-2 text-sm font-semibold text-white shadow-[0_1px_0_rgba(0,0,0,0.04)] hover:bg-neutral-800"
            >
              Contact
            </a>
          </div>
          ...
          <div className="relative grid gap-10 py-16 sm:py-20 md:grid-cols-12 md:items-start">
            <div className="md:col-span-7">
              ...
              <h1 className="mt-4 text-4xl font-semibold tracking-tight sm:text-6xl">
                ...
                <span className="block text-neutral-500">Des livraisons plus fiables.</span>
              </h1>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <a
                  href="#services"
                  className="rounded-xl border border-neutral-200 bg-neutral-900 px-5 py-3 text-sm font-semibold text-white shadow-[0_1px_0_rgba(0,0,0,0.04)] hover:bg-neutral-800"
                >
                  Voir les offres
                </a>
                <a
                  href="#cases"
                  className="rounded-xl border border-neutral-200 bg-white px-5 py-3 text-sm font-semibold shadow-[0_1px_0_rgba(0,0,0,0.04)] hover:bg-neutral-100"
                >
                  Exemples d’impact
                </a>
              </div>
            ...
            {/* Bloc éditorial "maîtrise" (remplace l'image) */}
            <div className="md:col-span-5">
              <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
                ...
                <p className="mt-4 text-xs text-neutral-500">Concret • Mesurable • Durable</p>
              </div>

              <div className="mt-4 rounded-2xl border border-neutral-200 bg-white p-5 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
          ...
          <div className="grid gap-10 md:grid-cols-12 md:items-start">
            ...
            <div className="md:col-span-7">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
                  <p className="text-sm font-semibold">Diagnostic rapide</p>
                  <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                    Observer le flux, clarifier les irritants, choisir peu d’actions à fort effet.
                  </p>
                </div>

                <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
                  <p className="text-sm font-semibold">Cadre de pilotage</p>
                  <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                    Quelques métriques utiles, un rythme de revue, une décision plus fluide.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                    Stabiliser l’exécution : limiter le WIP, réduire les reprises, sécuriser le done.
                  </p>
                </div>

                <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
                  <p className="text-sm font-semibold">Transfert</p>
                  <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                    Rendre l’organisation autonome : pratiques, supports, routine d’amélioration.
                  </p>
                </div>
              </div>
            </div>
        ...
        <Container>
          <div className="grid gap-10 md:grid-cols-12">
            <div className="md:col-span-5">
              ...
              <div className="mt-6 rounded-2xl border border-neutral-200 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
      ...
      <section id="cases" className="py-16 sm:py-20">
        <Container>
          ...
          <div className="mt-6 rounded-2xl border border-neutral-200 bg-white p-6 text-sm text-neutral-600 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
            <span className="font-semibold text-neutral-900">Option :</span> intégrer ici des “preuves”
            (avant/après, métriques, verbatims), en gardant la même sobriété.
          </div>
        </Container>
      </section>
                ...
                {[
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <span className="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-xl border border-neutral-200 bg-neutral-50 text-xs font-semibold text-neutral-700">
                        {item.step}
                      </span>
                      <div>
      ...
      {/* CONTACT (UI only, branchement API ensuite) */}
        ...
        <Container>
          <div className="grid gap-10 md:grid-cols-12 md:items-start">
            <div className="md:col-span-5">
              <SectionTitle
                eyebrow="Contact"
                title="Un premier échange, simple et direct"
                description="Décrivez votre contexte, votre enjeu, votre horizon. Je réponds avec une proposition claire."
              />

              <div className="mt-6 rounded-2xl border border-neutral-200 bg-white p-6 text-sm text-neutral-600 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
                <p className="font-semibold text-neutral-900">Réponse sous 48h ouvrées</p>
                <p className="mt-2">Format : 30 minutes — cadrage, questions, prochaines étapes.</p>
              </div>
            </div>

            <div className="md:col-span-7">
              <form className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                ...
                <div className="mt-4">
                  ...
                  <textarea
                    className="mt-2 min-h-[140px] w-full rounded-xl border border-neutral-200 bg-white px-4 py-3 text-sm outline-none focus:border-neutral-400"
                    placeholder="Contexte, enjeu, horizon…"
                    name="message"
                  />
                </div>
                ...
                <div className="mt-5 flex items-center justify-between gap-4">
                  <p className="text-xs text-neutral-500">
                    Branchement API : POST /api/contact/messages
                  </p>
                  <button
                    type="button"
                    className="rounded-xl border border-neutral-200 bg-neutral-900 px-5 py-3 text-sm font-semibold text-white shadow-[0_1px_0_rgba(0,0,0,0.04)] hover:bg-neutral-800"
